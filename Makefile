# ============================================================================
# MAKEFILE ANTERIOR (comentado, solo como referencia)
# ============================================================================
...
# SCRIPT      = fly_ing.py
#
# FLAKE8_EXCLUDE = --exclude=$(VENV),.venv
# MYPY_EXCLUDE   = --exclude $(VENV) --exclude .venv
#
# all: install
#
# $(VENV)/bin/python:
...
# Mapa por defecto para `make run` / `make debug`.
# Se sobreescribe así:  make run MAP=maps/hard/01_maze_nightmare.txt
